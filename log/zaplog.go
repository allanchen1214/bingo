...
// FileOption 设置日志文件保存选项
type FileOption struct {
	// 日志格式，PlainTextEncoder|JSONEncoder
	Encoder int
	// Debug及以上级别日志文件路径，默认./log/info.log
...
// ConsoleLogger Debug及以上级别日志输出到控制台
...
// RotateFileLogger 文件日志，通过options设置文件路径、日志格式以及压缩归档等参数
